package com.yesimengineer.survivorbird;
...
//Yazıların özelliklerinin Tanımı
		font= new BitmapFont();
...
//Karşıt nesnenin konumunun random bir şekilde gelmesi
...
//karşıt nesnelerin çarpışma alanlarının tanımı
	...
	public void render() {
		...
		//Scor yazısının konumu
		font.draw(batch,String.valueOf(score),100,200);
		batch.end();
		//Ana nesnenin konum tanımı
